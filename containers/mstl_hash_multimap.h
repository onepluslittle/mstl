...
void swap(hash_multimap& hs) {rep.swap(hs);}
iterator begin() {return rep.begin();}
iterator end() {return rep.end();}
const_iterator begin() const {return rep.begin();}
const_iterator end() const {return rep.end();}

friend bool operator== __STL_NULL_TEML_ARGS (const hash_multimap&, const hash_multimap&);
...
inline bool operator==(const hash_multimap<Key, T, HashFcn, EqualKey, Alloc>& hm1, const hash_multimap<Key, T, HashFcn, EqualKey, Alloc>& hm2) {
